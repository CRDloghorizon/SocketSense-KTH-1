...
if __name__ == '__main__':
    ...
    sensor5 = data['s5']
    ts = data['t']
    data = np.concatenate((sensor1, sensor2, sensor3, sensor4, sensor5), axis=0)
    #knnreport = knn(train, test, w, b)
    #print(knnreport)
    print(data.shape, ts.shape)

    centroid, locations = kmeans(data=data, k = 12, max_iter = 5, w = w, b = b, dm = 2)
    ...
    # plt.savefig('C:/Users/loghorizon/Desktop/thesis/rcri5.png')
    plt.show()
